...
def main():
    ...
    train_path = PROCESSED_DIR / f"problem_train_{version_tag}.jsonl"
    dev_path = PROCESSED_DIR / f"problem_dev_{version_tag}.jsonl"
    test_path = PROCESSED_DIR / f"problem_test_{version_tag}.jsonl"
