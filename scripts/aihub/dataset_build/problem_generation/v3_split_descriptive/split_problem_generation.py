...
PROBLEM_DIR = SCRIPT_DIR.parents[2] / "problem_generation" / "v3_split_descriptive"
if str(PROBLEM_DIR) not in sys.path:
    sys.path.insert(0, str(PROBLEM_DIR))

from scripts.aihub.problem_generation.v3_split_descriptive.common import write_csv_atomic, write_jsonl_atomic
from scripts.aihub.problem_generation.v3_split_descriptive.settings import (
...
if __name__ == "__main__":
    import csv
    from scripts.aihub.problem_generation.v3_split_descriptive.settings import MERGED_SCORES_PATH
