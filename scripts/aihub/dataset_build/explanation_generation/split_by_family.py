...
EXPLANATION_DIR = SCRIPT_DIR.parents[1] / "explanation_generation"
if str(EXPLANATION_DIR) not in sys.path:
    sys.path.insert(0, str(EXPLANATION_DIR))

from scripts.aihub.explanation_generation.common import write_csv_atomic, write_jsonl_atomic
from scripts.aihub.explanation_generation.settings import (
    AUDIT_QUEUE_PATH,
