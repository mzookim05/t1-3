...
# objective 대량 wave는 기존 medium runner를 재사용하되, counted seed 전체를 다시 제외하기 위해 새 version tag로 고정한다.
...
def configure_eval_aware_superwave_judgment() -> None:
    ...
    base = medium.base
    base.VERSION_TAG = "objective_non_law_eval_aware_superwave_judgment_preflight"
    base.RUN_DATE = build_run_stamp()
    base.RUN_PURPOSE = "objective_r2_non_law_judgment_candidate64_final40_eval_aware_preflight"
    base.RUN_NAME = f"{base.RUN_DATE}_{base.VERSION_TAG}_{base.RUN_PURPOSE}"
    base.RUN_LABEL = "non-law eval-aware superwave judgment preflight"
    base.SEED_ID_PREFIX = "nonlaw_eval_judgment_preflight"
    base.SEED_SELECTION_NOTE = "판결문_QA non-law eval-aware superwave seed for candidate 64 / final 40"
    base.NON_LAW_SCOPE_NOTE = "judgment_eval_aware_superwave_preflight_no_api_candidate_not_counted"
