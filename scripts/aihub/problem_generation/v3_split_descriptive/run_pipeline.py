...
from generate_split_descriptive_problems import main as generate_split_descriptive_problems
...
from scripts.aihub.dataset_build.problem_generation.v3_split_descriptive.split_problem_generation import (
...
def main():
    ...
    generate_split_descriptive_problems(mode="main")
    generate_split_descriptive_problems(mode="strict_finalize")
    run_problem_judges(mode="main")
    run_problem_judges(mode="strict_finalize")
    merged_rows = merge_problem_judge_scores()

    # dataset_build handoff는 절대 import한 split-descriptive 전용 split runner가 담당한다.
