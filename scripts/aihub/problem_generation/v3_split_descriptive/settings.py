...
# split-descriptive line의 산출물을 전용 폴더에 고정해 v1/v2/pb1 결과와 충돌하지 않게 한다.
INTERIM_DIR = PROJECT_ROOT / "data" / "interim" / "aihub" / "problem_generation" / "v3_split_descriptive"
PROCESSED_DIR = PROJECT_ROOT / "data" / "processed" / "aihub" / "problem_generation" / "v3_split_descriptive"
REFERENCE_PROCESSED_DIR = PROJECT_ROOT / "data" / "processed" / "aihub" / "explanation_generation" / "v7_strict_final"
REFERENCE_PROBLEM_V2_PROCESSED_DIR = (
    PROJECT_ROOT / "data" / "processed" / "aihub" / "problem_generation" / "v2_objective"
)
...
REFERENCE_PROBLEM_V2_MANIFEST_PATH = REFERENCE_PROBLEM_V2_PROCESSED_DIR / "dataset_manifest.csv"
