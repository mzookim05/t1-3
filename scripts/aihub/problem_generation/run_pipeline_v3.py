from build_problem_seed_registry_v3 import main as build_problem_seed_registry_v3
from common_v3 import build_run_manifest, write_json_atomic
from export_problem_examples_v3 import main as export_problem_examples_v3
from generate_split_descriptive_problems_v3 import main as generate_split_descriptive_problems_v3
from merge_problem_judge_scores_v3 import main as merge_problem_judge_scores_v3
from run_problem_judges_v3 import main as run_problem_judges_v3
...
def main():
    build_problem_seed_registry_v3()
    generate_split_descriptive_problems_v3(mode="main")
    generate_split_descriptive_problems_v3(mode="strict_finalize")
    run_problem_judges_v3(mode="main")
    run_problem_judges_v3(mode="strict_finalize")
    merged_rows = merge_problem_judge_scores_v3()
    ...
    from split_problem_generation_v3 import main as split_problem_generation_v3_main

    manifest_rows = split_problem_generation_v3_main(merged_rows)
    example_rows = export_problem_examples_v3()
