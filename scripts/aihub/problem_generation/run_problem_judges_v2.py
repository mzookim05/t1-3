...
ROLE_TO_PROMPT = {
    "Grounding": "judge_grounding_mcq.md",
    "Keyedness": "judge_keyedness_mcq.md",
    "DistractorFit": "judge_distractorfit_mcq.md",
}
...
def main(mode="main"):
    ...
    snapshot_prompts(["judge_grounding_mcq.md", "judge_keyedness_mcq.md", "judge_distractorfit_mcq.md"])
